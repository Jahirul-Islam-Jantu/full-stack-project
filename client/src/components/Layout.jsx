                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-12 gap-[30px] items-center">
                        <div className="col-span-2">
                            <div >
                                <Link to="/home"><img src="logo.png" className="w-[80px]" alt="Logo"/></Link>
                            </div>
                        </div>
                        <div className="col-span-7   ">
                            <nav className="flex justify-center" >
                                <ul className="flex  gap-[15px]">
                                    <li> <NavLink className={({isActive})=> (isActive? "px-[1rem] py-[0.6rem] bg-gray-700  rounded-xl text-white hover:text-slate-500 hover:bg-gray-200" : "px-[1rem] py-[0.6rem] bg-gray-200  rounded-xl") } to={"/home"} >Home</NavLink></li>
